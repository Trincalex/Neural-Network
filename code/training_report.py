...
class TrainingReport:
    ...
    def training_error(self, value : float) -> None:
    ...
    def validation_error(self, value : float) -> None:
    ...
    def training_accuracy(self, value : float) -> None:
    ...
    def validation_accuracy(self, value : float) -> None:
    ...
    def update(self, value) -> None:
        ...
        self.training_error         = value.training_error
        self.validation_error       = value.validation_error
        self.training_accuracy      = value.training_accuracy
        self.validation_accuracy    = value.validation_accuracy
